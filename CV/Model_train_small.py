...
class InceptionV3(object):
    ...
    def inception_base_stem():
        return InceptionV3.compose(
            #input:129*129*1
            InceptionV3.conv_batchnorm_leaky(16,(3,3),(2,2),'valid'),
            #output:64*64*32
            InceptionV3.conv_batchnorm_leaky(16,(3,3),(1,1),'same'),
            #output:64*64*32
            InceptionV3.conv_batchnorm_leaky(32,(3,3),(1,1),'valid'),
            #output:62*62*64
    ...
    def inception_block_a(x):
        #input:31*31*X
        branch1=InceptionV3.conv_batchnorm_leaky(16,(1,1),(1,1),'same')(x)

        branch2=InceptionV3.conv_batchnorm_leaky(16,(1,1),(1,1),'same')(x)
        branch2=InceptionV3.conv_batchnorm_leaky(16,(3,3),(1,1),'same')(branch2)

        branch3=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(3,3),(1,1),'same')(branch3)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(3,3),(1,1),'same')(branch3)
    ...
    @staticmethod
    def subsample_a(x):
        branch1=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch1=InceptionV3.conv_batchnorm_leaky(32,(3,3),(2,2),'valid')(branch1)

        branch2=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch2=InceptionV3.conv_batchnorm_leaky(32,(3,3),(1,1),'same')(branch2)
        branch2=InceptionV3.conv_batchnorm_leaky(32,(3,3),(2,2),'valid')(branch2)
    ...
    def inception_block_b(x):
        ...
        branch2=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch2=InceptionV3.conv_batchnorm_leaky(32,(1,5),(1,1),'same')(branch2)
        branch2=InceptionV3.conv_batchnorm_leaky(64,(5,1),(1,1),'same')(branch2)

        branch3=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(5,1),(1,1),'same')(branch3)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(1,5),(1,1),'same')(branch3)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(5,1),(1,1),'same')(branch3)
        branch3=InceptionV3.conv_batchnorm_leaky(64,(1,5),(1,1),'same')(branch3)

        branch4=AveragePooling2D(pool_size=(3,3),strides=(1,1),padding='same')(x)
        branch4=InceptionV3.conv_batchnorm_leaky(64,(1,1),(1,1),'same')(branch4)
        #output:15*15*224
        result=concatenate([branch1,branch2,branch3,branch4],axis=-1)
    ...
    def subsample_b(x):
        ...
        branch2=InceptionV3.conv_batchnorm_leaky(64,(1,5),(1,1),'same')(branch2)
        branch2=InceptionV3.conv_batchnorm_leaky(64,(5,1),(1,1),'same')(branch2)
        branch2=InceptionV3.conv_batchnorm_leaky(64,(3,3),(2,2),'valid')(branch2)
    ...
    def inception_block_c(x):
        ...
        branch2=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch21=InceptionV3.conv_batchnorm_leaky(32,(1,3),(1,1),'same')(branch2)
        branch22=InceptionV3.conv_batchnorm_leaky(32,(3,1),(1,1),'same')(branch2)
        branch2=concatenate([branch21,branch22],axis=-1)

        branch3=InceptionV3.conv_batchnorm_leaky(32,(1,1),(1,1),'same')(x)
        branch3=InceptionV3.conv_batchnorm_leaky(32,(3,3),(1,1),'same')(branch3)
        branch31=InceptionV3.conv_batchnorm_leaky(32,(3,1),(1,1),'same')(branch3)
        branch32=InceptionV3.conv_batchnorm_leaky(32,(1,3),(1,1),'same')(branch3)
    ...
    @staticmethod
    def softmax(x):
        x=InceptionV3.conv_batchnorm_leaky(256,(1,1),(1,1),'same')(x)
